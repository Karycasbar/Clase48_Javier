...
function preload(){
  ...
  fuegoImg = loadImage("assets/fuego2.png");
...
function enemy(){
  if(frameCount%50===0){
    ...
    //posiciones aleatorias del zombie para afectar escalas
    posiciones = [100, 300, 500];
    var rand = Math.round(random(posiciones));
    switch(rand){ 
    case 100: zombie.addImage(zombieImg);
              zombie.scale = 0.05;
              zombie.y = 100;
              
            break;
    case 300: zombie.addImage(zombieImg);
              zombie.scale = 0.10;
              zombie.y = 300;
            break;
    case 500: zombie.addImage(zombieImg);
              zombie.scale = 0.15;
              zombie.y = 500;
            break;
    default: break;
